  ...
  if (ticketData) {
    try {
      ...
      document.getElementById("eventTitle").textContent =
        ticket.title || "Event Title Not Available";
      ...
      document.getElementById("generalPrice").textContent = ticket.generalPrice
        ? `$${ticket.generalPrice}`
        : "N/A";
      document.getElementById("vipPrice").textContent = ticket.vipPrice
        ? `$${ticket.vipPrice}`
        : "N/A";
      document.getElementById("earlyBirdPrice").textContent =
        ticket.earlyBirdPrice ? `$${ticket.earlyBirdPrice}` : "N/A";
